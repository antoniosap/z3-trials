...
def g15():
    ...
    for k in range(BOARDS - 1):
        ...
        fixed_c.append(And(X[k][0][0] > 0, X[k + 1][0][0] > 0, X[k][0][0] == X[k + 1][0][0],
                           ...
                           X[k][1][0] > 0, X[k + 1][1][0] > 0, X[k][1][0] == X[k + 1][1][0],
                           X[k][1][1] > 0, X[k + 1][1][1] > 0, X[k][1][1] == X[k + 1][1][1],
                           X[k][2][0] > 0, X[k + 1][2][0] > 0, X[k][2][0] == X[k + 1][2][0],
                           X[k][2][1] > 0, X[k + 1][2][1] > 0, X[k][2][1] == X[k + 1][2][1]))
        # quadrante CE
        #   | 0  1  2  3
        # --|-----------
        # 0 | 1, 2, 3, _
        ...
        # 2 | 9,10,11, _
        # 3 |13,14,15, _
        fixed_c.append(And(X[k][1][0] > 0, X[k + 1][1][0] > 0, X[k][1][0] == X[k + 1][1][0],
                           X[k][1][1] > 0, X[k + 1][1][1] > 0, X[k][1][1] == X[k + 1][1][1],
                           X[k][1][2] > 0, X[k + 1][1][2] > 0, X[k][1][2] == X[k + 1][1][2],
                           X[k][2][0] > 0, X[k + 1][2][0] > 0, X[k][2][0] == X[k + 1][2][0],
                           X[k][2][1] > 0, X[k + 1][2][1] > 0, X[k][2][1] == X[k + 1][2][1],
                           X[k][2][2] > 0, X[k + 1][2][2] > 0, X[k][2][2] == X[k + 1][2][2],
                           X[k][3][0] > 0, X[k + 1][3][0] > 0, X[k][3][0] == X[k + 1][3][0],
        ...
        # 2 | _,10,11,12
        # 3 | _,14,15,16
        fixed_c.append(And(X[k][1][1] > 0, X[k + 1][1][1] > 0, X[k][1][1] == X[k + 1][1][1],
                           X[k][1][2] > 0, X[k + 1][1][2] > 0, X[k][1][2] == X[k + 1][1][2],
                           X[k][1][3] > 0, X[k + 1][1][3] > 0, X[k][1][3] == X[k + 1][1][3],
                           X[k][2][1] > 0, X[k + 1][2][1] > 0, X[k][2][1] == X[k + 1][2][1],
                           X[k][2][2] > 0, X[k + 1][2][2] > 0, X[k][2][2] == X[k + 1][2][2],
        ...
        # 2 | 9,10, _, _
        # 3 |13,14, _, _
        fixed_c.append(And(X[k][2][0] > 0, X[k + 1][2][0] > 0, X[k][2][0] == X[k + 1][2][0],
                           X[k][2][1] > 0, X[k + 1][2][1] > 0, X[k][2][1] == X[k + 1][2][1],
                           X[k][3][0] > 0, X[k + 1][3][0] > 0, X[k][3][0] == X[k + 1][3][0],
                           X[k][3][1] > 0, X[k + 1][3][1] > 0, X[k][3][1] == X[k + 1][3][1]))
        # # quadrante SW
    ...
    cell_zero_c = []
    # for k in range(BOARDS - 1):
    #    cell_zero_c.append(And(X[k][3][3] == 0, X[k + 1][3][3] == 0))
